...
Source0  : https://www.openinfosecfoundation.org/download/suricata-7.0.4.tar.gz
Source1  : https://www.openinfosecfoundation.org/download/suricata-7.0.4.tar.gz.sig
...
%prep
%setup -q -n suricata-7.0.4
cd %{_builddir}/suricata-7.0.4
pushd ..
cp -a suricata-7.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710875313
